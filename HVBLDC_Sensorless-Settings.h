/* =================================================================================
File name:  HVBLDC_Sensorless-Settings.H                     
...
#define LEVEL3  3           // Verify CMTN_TRIG module
#define LEVEL4  4           // Verify the closed loop based on the computed BEMF zero crossings
